    ...
    <div class="container">
        <div class="forms">
            <div class="form register">
                <span class="title">Member Registeration</span> 
                ...
                <form action="#">
                    ...
                    <div class="input-field">
                      <input type="text" v-model="contactno" :class="{invalid: isSubmitting && !contactno.trim() }" placeholder="Contact Number" required/>
                    ...
                    <div class="input-field button">
                        <input type="button" @click.prevent="validate" value="Register">
                    </div>
                </form>
...
const Welcome = (props) => {
  if (props.match.path === "/confirm/:confirmationCode") {
    auth.verifyUser(props.match.params.confirmationCode);
  }
}

export default {
  name: "RegisterSite", Welcome,
  data() {
    return{
      name: "",
      email: "",
