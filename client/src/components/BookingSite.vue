    ...
    <div class="container-book-form col-lg-12 bg-white shadow p-4 rounded">
        ...
        <form>
            <div class="input_field">
                <label>Who are you booking for? <span>*</span></label><br>
                <div class="radio-option">
                    <input type="radio" id="radio-option" name="option">
                    <label>Booking for myself</label><br>
                    <input type="radio" id="radio-option" name="option">
                    <label>Booking for someone else</label><br>
                </div>   
            </div>
            <div class="input_field">
            ...
            <div class="input_field">
                ...
                <textarea class="form-control shadow-none" placeholder="Special requests cannot be guaranteed - but the property will do its best to meet your expectations." id="sreq"></textarea>
            </div>
            <div class="input_field">
            ...
            <div class="submit">
                <button type="submit" class="btn text-white shadow none">Pay </button>
            </div>
        </form>
    </div>
</template>
