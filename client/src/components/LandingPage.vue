    ...
    <div class="container">
      <div class="row justify-content-between gy-5">
        ...
        <div class="col-lg-5 order-1 order-lg-2 text-center text-lg-start">
          <img src="../assets/img/main.jpg" class="main-image" alt="Mainimage">
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="tab-content" data-aos="fade-up" data-aos-delay="300">
          ...
          <div class="tab-pane fade active show" id="destination-north">
            ...
            <div class="gallery">
              <img src="../assets/img/Gallery/north_1.jpg" alt="Nallur Kandaswamy Kovil">
              <div class="desc">Nallur Kandaswamy Kovil</div>
            </div>

            <div class="gallery">
              <img src="../assets/img/Gallery/north_2.jpg" alt="Jaffna Fort">
          ...
          <div class="tab-pane fade" id="destination-south">
            ...
            <div class="gallery">
              <img src="../assets/img/Gallery/south_5.jpg" alt="Hikkaduwa coral reefs">
              <div class="desc">Hikkaduwa coral reefs</div>
            </div>

            <div class="gallery">
              <img src="../assets/img/Gallery/south_6.jpg" alt="Kumana National Park">
          ...
          <div class="tab-pane fade" id="destination-west">
            ...
            <div class="gallery">
              <img src="../assets/img/Gallery/west_5.jpg" alt="Pahiyangala">
              <div class="desc">Pahiyangala</div>
            </div>

            <div class="gallery">
              <img src="../assets/img/Gallery/west_6.jpg" alt="Leisure World Water Park">
          ...
          <div class="tab-pane fade" id="destination-east">
            ...
            <div class="gallery">
              <img src="../assets/img/Gallery/east_6.jpg" alt="Sri Thirukoneswaram Kovil">
          ...
          <div class="tab-pane fade" id="destination-central">
            ...
            <div class="gallery">
              <img src="../assets/img/Gallery/central_2.jpg" alt="Ramboda Falls">
